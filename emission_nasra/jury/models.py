...
class Jury(models.Model):
    ...
    site_web = models.EmailField(max_length=254, blank=True, default="")
    facebook = models.EmailField(max_length=254, blank=True, default="")
    twitter = models.EmailField(max_length=254, blank=True, default="")
